 ...
 * @author Gaara-X
 */
public class FacturamentoDiaBebida extends javax.swing.JFrame {
    MetodosCRUD mcrud = new MetodosCRUD();
    Listas listas = new Listas();
    /**
     * Creates new form FacturamentoDia
     */
    public FacturamentoDiaBebida() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        facturamentoDiaTB.setModel(mcrud.facturamentoDiaBebida());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturamentoDiaBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturamentoDiaBebida().setVisible(true);
            }
        });
    }
