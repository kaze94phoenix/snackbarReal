 ...
 * @author Gaara-X
 */
public class FacturamentoDia extends javax.swing.JFrame {
    MetodosCRUD mcrud = new MetodosCRUD();
    Listas listas = new Listas();
    /**
     * Creates new form FacturamentoDia
     */
    public FacturamentoDia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        facturamentoDiaTB.setModel(mcrud.facturamentoDia());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturamentoDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
