...
public class FacuramentoReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dia mais facturado");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setText("7820 MT");

        jLabel4.setText("25-05-2016");
        ...
        jLabel5.setText("Relatórios sobre Facturamento");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==1){
            ...
            x="semana";
            chart = ChartFactory.createBarChart("Total facturado durante a semana "+range, x,y, dataset,PlotOrientation.VERTICAL,false,true,false);
        }
        //se seleccionar mes
            ...
            x="diss";
            chart = ChartFactory.createBarChart("Total facturado durante o corrente mês " + range, x, y, dataset, PlotOrientation.VERTICAL, false, true, false);
        ...
        //seleccionar ano
            ...
            x="ano";
            chart = ChartFactory.createBarChart("Total facturado durante o corrente ano " + range, x, y, dataset, PlotOrientation.VERTICAL, false, true, false);
        }
        //otherwise
        else{
            return;
